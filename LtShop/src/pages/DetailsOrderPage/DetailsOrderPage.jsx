        ...
        <div style={{ width: '1270px', margin: '0 auto', height: '1270px' }}>
          ...
          <WrapperHeaderUser>
            ...
            <WrapperInfoUser>
              ...
              <WrapperContentInfo>
                <div className='delivery-info'><span className='name-delivery'>TL </span>Giao hàng tiết kiệm</div>
            ...
            <WrapperInfoUser>
              ...
              <WrapperContentInfo>
                <div className='status-payment'>{orderContant.payment[data?.paymentMethod]}</div>

                {data?.paymentMethod === 'paypal' && (
                  <div className='payment-info'>Đã thanh toán</div>
                )}
              </WrapperContentInfo>
            </WrapperInfoUser>
          </WrapperHeaderUser>
          <WrapperStyleContent style={{ background: '#fff', padding: '20px' }}>
